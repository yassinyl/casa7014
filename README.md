...
| <img src="https://cdn.jsdelivr.net/gh/walkxcode/dashboard-icons/png/tvheadend.png" width="48" height="48"> | **Nodecast TV** | `2.1.1` | A self-hosted TV streaming application with a browser-based interface. |
